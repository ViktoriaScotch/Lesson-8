...
public class ApiTest {
  ...
  public void prepare() throws IOException {
    ...
    RestAssured.requestSpecification = new RequestSpecBuilder()
            ...
            .addHeader("api_key", System.getProperty("api_key")) // задаём заголовок с токеном для авторизации
  ...
  public void checkObjectSave() {
    ...
    id = new Random().nextInt(500000); // просто нужно создать произвольный айди
  ...
  @Test
  public void petDelete() throws IOException {
    System.getProperties().load(ClassLoader.getSystemResourceAsStream("set.properties"));
    given()
            .pathParam("petId", id)
            .when()
